---
title: "RPart Prp Project Documentation"
output: html_document
---

## Aim
The aim of Rpart application is to demostrate the use of the prp funciton in the rpart.port packages and illustrate the effort of different parameter values. 
...
RPart application has two sections. Left section lets you interject values and interact with controls, while the right side show you the result of the rpart plot. 
